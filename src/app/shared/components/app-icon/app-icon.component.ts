...
@Component({
  ...
  template: `
    <svg
      ...
      [attr.class]="customClass() || 'w-4 h-4'"
...
export class AppIconComponent {
  ...
  readonly customClass = input<string>('w-4 h-4');
  ...
  private readonly iconMap: Record<string, string> = {
    ...
    'utensils': '<path d="M18 2v6a3 3 0 0 1-3 3 3 3 0 0 1-3-3V2"/><path d="M18 11v9a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-9"/><path d="M6 2v6a3 3 0 0 0 3 3 3 3 0 0 0 3-3V2"/>',
    ...
    'payments': '<rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/><path d="M12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>',
    ...
    'done-all': '<path d="M18 6 7 17l-5-5"/><path d="m22 10-7.5 7.5L13 16"/>',
    'room-service': '<path d="M2 18h20"/><path d="M4 18v-2a8 8 0 0 1 16 0v2"/><path d="M12 4a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>',
    'speed': '<circle cx="12" cy="12" r="10"/><path d="m16 8-4.5 4.5"/><path d="M8 12a4 4 0 0 1 8 0"/>',
    ...
    'tapas': '<circle cx="12" cy="12" r="8"/><path d="M12 4v16"/><path d="M4 12h16"/>',
    'icecream': '<path d="M7 11h10a4 4 0 0 0-4-4 4 4 0 0 0-4 4Z"/><path d="m7 11 5 10 5-10"/>',
    ...
    'receipt-long': '<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z"/><path d="M14 8H8"/><path d="M16 12H8"/><path d="M13 16H8"/>',
    'cleaning-services': '<path d="m19 11-8-8-8.6 8.6a2 2 0 0 0 0 2.8l5.2 5.2c.8.8 2 .8 2.8 0L19 11Z"/><path d="m5 2 5 5"/><path d="M2 5l5 5"/><path d="m22 20-2 2-5-5 2-2 5 5Z"/>',
  ...
  readonly svgContent = computed<SafeHtml>(() => {
    ...
    const key = rawName.toLowerCase().replace(/([a-z])([A-Z])/g, '$1-$2');
    const raw = this.iconMap[key] || this.iconMap[rawName] || this.iconMap['settings'];
